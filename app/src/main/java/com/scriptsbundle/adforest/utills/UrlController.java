...
public class UrlController {
    ...
    private static String Purchase_code = "aaBMQWH8vIWZjZOR07nEyJbOnqrzWbHS";
    private static String Custom_Security = "212PQoz1zAICAxvui55AZuSTNhajjTTk"; //Custom security can be any random string like your name or 1234
    private static String IP_ADDRESS = "http://18.191.245.164/";
