...
public class HomeActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, RuntimePermissionHelper.permissionInterface, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private void adforest_loctionSearch() {
        ...
        if (gps.canGetLocation()) {
            ...
            if (addresses.get(0).getAddressLine(0).isEmpty()) {
                ...
                currentLocationText.setHint(addresses.get(0).getAddressLine(0));
